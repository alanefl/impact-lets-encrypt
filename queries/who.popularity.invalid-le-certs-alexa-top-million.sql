...
-- Returns the number of domains with NON-VALID LE certificates binned by chunks of 100,000
...
WHERE
    ...
    -- Censys says browsers don't trust this certificate
    AND NOT p443.https.tls.validation.browser_trusted
